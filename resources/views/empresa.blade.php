        ...
        <div class="container py-5">
            ...
            <div class="row">
                <div class="col-md-4 text-center" data-aos="zoom-in">
                    <img src="{{ asset('main/images/compromiso.png') }}" alt="Compromiso" class="img-fluid mb-2 shadow">
                    <h4>Compromiso</h4>
                ...
                <div class="col-md-4 text-center" data-aos="zoom-in" data-aos-delay="100">
                    <img src="{{ asset('main/images/honestidad.png') }}" alt="Honestidad" class="img-fluid mb-2 shadow">
                    <h4>Honestidad</h4>
                ...
                <div class="col-md-4 text-center" data-aos="zoom-in" data-aos-delay="200">
                    <img src="{{ asset('main/images/pasion.png') }}" alt="Pasión" class="img-fluid mb-2 shadow">
                    <h4>Pasión</h4>
                ...
                <div class="col-md-4 text-center" data-aos="zoom-in" data-aos-delay="300">
                    <img src="{{ asset('main/images/solidaridad.png') }}" alt="Solidaridad" class="img-fluid mb-2 shadow">
                    <h4>Solidaridad</h4>
                ...
                <div class="col-md-4 text-center" data-aos="zoom-in" data-aos-delay="400">
                    <img src="{{ asset('main/images/competitividad.png') }}" alt="Competitividad" class="img-fluid mb-2 shadow">
